...
class Trendtracker
{
	...
	public:
		...
		// First, push back an empty entry and find where the string belongs using linear search.
		// Second, if the entry is not repeated, keep track of the location where it belongs.
		// Third, move to the end of the vector and begin shifting everything to empty the space where the hashtag belongs.
		// Fourth, after the loop finishes, place the hashtag where it belongs. 
